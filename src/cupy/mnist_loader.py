...
# this definitly could use some tweaking, for me, at the moment, cupy is slower
# than numpy for training. That implies that I am doing something wrong.
...
def load_random_image():
    ...
    pixels = tr_d[0][pos]
    expected = tr_d[1][pos]
    return (pixels, cp.reshape(pixels, (784, 1)), expected)
